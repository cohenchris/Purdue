...
public class TestHeap {
    ...
    @Test(timeout = 10000)
    public void testSampleHeap1() throws IOException {
        checkOutput("sampleHeap1.txt", TEMP_FILE);
    }

    @Test(timeout = 10000)
    public void testSampleHeap2() throws IOException {
        checkOutput("sampleHeap2.txt", TEMP_FILE);
    }

    @Test(timeout = 10000)
    public void testSampleHeap3() throws IOException {
        checkOutput("sampleHeap3.txt", TEMP_FILE);
    }

    @Test(timeout = 10000)
    public void testSampleHeap4() throws IOException {
        checkOutput("sampleHeap4.txt", TEMP_FILE);
    }

    @Test(timeout = 10000)
    public void testSampleHeap5() throws IOException {
        checkOutput("sampleHeap5.txt", TEMP_FILE);
    }
